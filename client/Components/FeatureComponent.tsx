        ...
        <Box py={4}>
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="h6" component="h3" color="#00009f" gutterBottom={true}>VISUALIZE</Typography>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="h6" component="h3" color='#00009f' gutterBottom={true}>GENERATE</Typography>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="h6" component="h3" color="#00009f" gutterBottom={true}>EXPLORE</Typography>
